            ...
            <div class="modal">
                <div class="modal-box w-11/12 max-w-5xl text-center">
                    ...
                    <div className='mt-3'>
                        ...
                        <p> Used Technologies: HTML , Tailwind CSS, React.JS, Hero Icon, React Router, Firebase, Node JS, Express JS, MongoDB, Heroku, React toastifys</p>
                        <a className="btn text-white bg-gradient-to-r from-cyan-500 to-blue-500 mr-3" href='https://github.com/mohammad-al-amin-islam/tools-artisan-client-side' target='_blank' rel='noreferrer'>GitHub Link</a>
